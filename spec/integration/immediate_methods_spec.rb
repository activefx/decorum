...
describe "When overriding original methods with .immediate" do
  ...
  it "overrides original methods" do
    base_object.use_decorum(Decorum::Examples::StrongWilledDecorator)
  ...
  it "recurses" do
    4.times { base_object.use_decorum(Decorum::Examples::ImmediateDecorator) }
    expect(base_object.increment_immediately_shared).to eq(4)
  end

  it "recurses on namespaced decorator" do
    4.times { base_object.use_decorum(Decorum::Examples::ImmediateDecorator, namespace: :foo) }
